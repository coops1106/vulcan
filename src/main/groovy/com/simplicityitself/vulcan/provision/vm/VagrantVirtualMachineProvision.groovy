...
class VagrantVirtualMachineProvision implements VirtualMachineProvisioner {
  ...
  void disconnect() {
    if (System.properties["keeprunning"] != null) {
      com.simplicityitself.vulcan.provision.vm.VagrantVirtualMachineProvision.log.info "Keeping running by user request"
      return
    }
...
Vagrant::Config.run do |config|
  ...
  void setupVagrantStorage() {
    ...
    if (!vagrantBaseDir) {
      ...
      com.simplicityitself.vulcan.provision.vm.VagrantVirtualMachineProvision.log.info "Vagrant resources at $vagrantBaseDir"
    }
  }
  ...
  void ensureVagrantWorks() {
    ...
    com.simplicityitself.vulcan.provision.vm.VagrantVirtualMachineProvision.log.info "Vagrant is installed and functional"
  }
